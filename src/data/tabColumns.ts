...
export const STATUS_CONSTRUCTION_COLUMNS: ColumnDefinition[] = [
  ...
  { key: 'statusPullingCableFo', label: 'Status Pulling Cable FO', width: '190px', align: 'left' },
  { key: 'statusPullingCableCoax', label: 'Status Pulling Cable Coax', width: '190px', align: 'left' },
